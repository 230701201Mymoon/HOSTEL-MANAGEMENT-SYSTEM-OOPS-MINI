...
public class HosteliteManager extends JFrame {
    private JTextField nameField, rollNumberField, roomNumberField, genderField, courseField, statusField;
    private JButton addButton, removeButton, updateButton, searchButton, displayButton;
